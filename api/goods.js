...
const EN_TO_KR = {
  ...
  'TWS': '투어스',
  'CSR': '씨에스알',
  // group ID slug → 공식명 (fetchAllGroupGoods에서 slug가 넘어올 때 처리)
  'riize': 'RIIZE',
  ...
  'billlie': 'Billlie',
  'kep1er': 'Kep1er',
  'ampersandone': 'AMPERS&ONE',
  'xdinaryheroes': 'Xdinary Heroes',
  'alphadriveone': 'ALPHA DRIVE ONE',
  'queenzeye': 'Queenz Eye',
  'crazangel': 'CrazAngel',
  'heartofwoman': 'HEART OF WOMAN',
  'andteam': '&TEAM',
  ...
  'hrtswav': 'hrtz.wav',
  'flareu': 'FLARE U',
  'hpeprincess': 'H//PE Princess',
  'xnghananxoul': 'XngHan&Xoul',
  'ejel': 'EJel',
  'onewe': 'ONEWE',
  'rothy': 'Rothy',
  'umyull': 'UmYull',
